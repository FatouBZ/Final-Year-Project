                  ...
                  subtitle: Row(
                    ...
                    children: [
                      Container(
                        //height: 200,
                        width: double.infinity,
                        decoration: BoxDecoration(color: order['deliverystatus'] == 'delivered' ?Colors.brown.withOpacity(0.2)
                        ...
                        child: Column(
                          ...
                          ( DateFormat('yyyy-MM-dd').format (order['deliverydate'].toDate)
                          ).toString(),
                          style: const TextStyle(fontSize: 15))
                          :const Text(''),
                          ...
                          TextButton(onPressed: (){},
                           ...
                           :  const Text(''),
                           order['deliverystatus'] == 'deliverydate' && order['orderreview'] == true
                           ?Row(
                            children: const[
