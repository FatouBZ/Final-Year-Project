                  ...
                  title: Padding(
                    ...
                    child: Container(
                      ...
                      Flexible(child:  Column(
                        ...
                        children: [Text(widget.order['ordername'], 
                  ...
                  subtitle: Row(
                    ...
                    children: [
                      Container(
                        height: 200,
                        width: double.infinity,
                        decoration: BoxDecoration(color: widget.order['deliverystatus'] == 'delivered' ?Colors.brown.withOpacity(0.2)
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            Row(
                              children: [
                               const Text(('Payment Status: '),
                                ...
                                style: const TextStyle(fontSize: 15, color: Color.fromARGB(255, 33, 212, 243),),),
                              ],
                            ),
                             Row(
                               children: [
                            ...
                            ( DateFormat('yyyy-MM-dd').format (widget.order['deliverydate'].toDate)
                            ).toString(),
                            style: const TextStyle(fontSize: 15))
                            :const Text(''),
                            widget.order['deliverystatus'] == 'delivered' && widget.order['orderreview'] == false?
                            TextButton(onPressed: (){
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  TextField(decoration: InputDecoration(
                                    ...
                                    BlueButton(label: 'Ok', onPressed: () async{
                                     CollectionReference collref = 
                                     FirebaseFirestore.instance.collection('products').doc(widget.order[
                                      'productid'
                                     ])
                                     .collection('reviews');
                                     ...
                                     .set({
                                      ...
                                      await FirebaseFirestore.instance.runTransaction((transaction) async{
                                       ...
                                       FirebaseFirestore.instance.collection('orders').doc(widget.order[
                                      'orderid'
                                     ]);
                             ...
                             :  const Text(''),
                             widget.order['deliverystatus'] == 'delivered' && widget.order['orderreview'] == true
                             ?Row(
                              children: const[
