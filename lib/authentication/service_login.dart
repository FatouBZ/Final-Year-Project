...
class ServiceLogin extends StatefulWidget {
  ...
  @override
  State<ServiceLogin> createState() => _ServiceSignupState();
}

class _ServiceSignupState extends State<ServiceLogin> {
  late String email;
  ...
  setState(() {
   ...
   if (_formKey.currentState!.validate()) {
                              ...
                              .signInWithEmailAndPassword(email: email, password: password);
                               ...
                               Navigator.pushReplacementNamed(context, '/service_home')
                               );
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      HaveAccount(
                        ...
                        actionLabel: 'Sign Up',
                        onPressed: () {
                          Navigator.pushReplacementNamed(context, '/service_signup');
                        },
                      ),
                     processing ==true  
