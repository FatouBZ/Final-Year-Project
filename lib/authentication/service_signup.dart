...
class ServiceRegister extends StatefulWidget {
  const ServiceRegister({Key? key}) : super(key: key);

  @override
  State<ServiceRegister> createState() => _ServiceSignupState();
}

class _ServiceSignupState extends State<ServiceRegister> {
  ...
  setState(() {
   ...
   if (_formKey.currentState!.validate()) {
                            if (_imageFile != null) {
                              ...
                              Navigator.pushReplacementNamed(context, '/service_login')
                              );
