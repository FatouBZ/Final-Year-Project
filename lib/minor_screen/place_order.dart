              ...
              child: Scaffold(
                                    ...
                                    height: 100,
                                     ...
                                     child: Row(
                                      ...
                                      ClipRRect(
                                        ...
                                        child: Image.network(order.imageqUrl.first)
                                        )
                                        ),
                                        Flexible (
                ...
                bottomSheet: Container(
                  ...
                  child: Padding(
                    ...
                    child: BlueButton(label: 'Confirm ${totalPrice.toStringAsFixed(2)} GH₵',
                     width: 1, onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => const PayementScreen()));
                     },),
                  ),
                ),
              ),
